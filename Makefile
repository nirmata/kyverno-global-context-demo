...
test-gctx: 
	...
	make run --  k6/tests/gctx-demo.js --vus 100 --iterations 1000
	kubectl delete -f gctx-policy.yaml

.PHONY: test-api-call
test-api-call:
	kubectl apply -f apicall-policy.yaml
	make run --  k6/tests/gctx-demo.js --vus 100 --iterations 1000
	kubectl delete -f apicall-policy.yaml
